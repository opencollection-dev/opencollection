 ...
 *
 * Once the variable is revealed (showing its resolved value) the card is dropped —
 * it would only repeat what is already on screen. Secrets and unknown names stay
 * as their `{{token}}` even with show-vars on, so they keep the card.
 */
