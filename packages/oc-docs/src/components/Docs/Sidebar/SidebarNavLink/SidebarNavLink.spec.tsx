...
describe('SidebarNavLink', () => {
  ...
  it('indents by level via margin (one 19px chevron+gap step per level) with a uniform 8px inner pad', () => {
    ...
    // level * 19px = 38px -> 38/16 = 2.375rem left margin (one 19px step per level); the 8px
    // (0.5rem) pad is uniform across folders and leaves so glyphs line up under their parent.
